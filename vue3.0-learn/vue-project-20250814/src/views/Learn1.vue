...
//事件参数
const emitAlertClick = (email, password) => {
  alert("AlertBox clicked!" + "email:" + email + ",pasword:" + password);
};
...
<template>
  <div>
    ...
    <!--slot学习 -->
    <AlertBox @my-submit="emitAlertClick('lll@163.com', '123456')">
    ...
    <!--学习透穿Attributes -->
    <MyButton class="large" style="background-color: red" />
