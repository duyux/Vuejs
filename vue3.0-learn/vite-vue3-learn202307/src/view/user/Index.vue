<template>
    <div>
        <el-card>
            ...
            <!--分页-->
            <el-pagination :total="total" :current-page="searchForm.current" :page-size="searchForm.size"
                :page-sizes="[10,20,30,40]" @current-change="handleCurrentChange" layout="->,total,sizes,prev,pager,next.jumper"
...
import { ElMessage, ElMessageBox, EIMessage } from 'element-plus';
